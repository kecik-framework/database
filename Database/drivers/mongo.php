...
class Kecik_Mongo
{
    ...
    public function find( $table, $condition = array(), $limit = array(), $order_by = array() )
    {
        ...
        $query = QueryHelperMongo::find($table, $condition, $limit, $order_by);
        $res   = $this->exec($query);
    ...
    public function fields( $table )
    {
        ...
        if ( empty( $this->_fields ) ) {
            $query = QueryHelperMongo::find($table, array(), array( 1 ), array());
