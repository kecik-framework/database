...
class Kecik_Oci8
{
    ...
    public function insert( $table, $data )
    {
        ...
        if ( empty( $this->_pk ) )
            $query = "INSERT INTO \"" . strtoupper($this->username) . "\".\"" . strtoupper(
                    $table
                ) . "\" ($fields) VALUES ($values) RETURNING id into :id";
        else {
            $query = "INSERT INTO \"" . strtoupper($this->username) . "\".\"" . strtoupper(
                    $table
                ) . "\" ($fields) VALUES ($values) RETURNING " . $this->_pk . " into :id";
        }
    ...
    public function update( $table, $id, $data )
    {
        ...
        $query        = "UPDATE \"" . strtoupper($this->username) . "\".\"" . strtoupper(
                $table
            ) . "\" SET $fieldsValues $where";
    ...
    public function insertId( $field_id = '' )
    {
